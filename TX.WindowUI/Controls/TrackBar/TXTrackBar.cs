...
namespace TX.WindowUI.Controls
{
    ...
    public class TXTrackBar :  TXControlBase, ITXControl
    {
        ...
        TrackBarThemeBase _xtheme = null;
        ...
        public TrackBarThemeBase XTheme
        {
            get
            {
                return _xtheme;
        ...
        [Browsable(false),EditorBrowsable(EditorBrowsableState.Never)]
        public TXControlType ControlType
        {
            get { return TXControlType.TrackBar; }
        }
        ...
        protected override void OnMouseDown(MouseEventArgs e)
        {
            ...
            if (e.Button == System.Windows.Forms.MouseButtons.Left)
            {
                ...
                if (BTR.Contains(e.Location))
                {
                    ...
                    thumbButton.State = TXButtonState.Pressed;
                }
        ...
        protected override void OnMouseUp(MouseEventArgs e)
        {
            ...
            if (e.Button == System.Windows.Forms.MouseButtons.Left)
            {
                ...
                if (BTR.Contains(e.Location))
                    thumbButton.State = TXButtonState.Hover;
                else
                    thumbButton.State = TXButtonState.Normal;
            }
        }
        ...
        {
            base.OnMouseWheel(e);
            if (isMouseDownInButton || this.Focused)
            {
                if (e.Delta > 0)
                {
                    ValueAdd(SmallChange);
        ...
        public class GMTrackBarPaintEventArgs : PaintEventArgs
        {
            ...
            public TXButtonState BtnState { get; set; }

...
{
    [ToolboxItem(true)]
    public class RollingBar : TXControlBase, ITXControl
   {
        ...
        {            
            ...
            XTheme = new RollingBarThemeBase();
        }        

        #endregion

        #region event
            public event EventHandler StypeChange;
            protected virtual void OnStypeChange(EventArgs e)
            {
        ...
        public RollingBarThemeBase XTheme
        {
            get
            {
                return _xtheme;
        ...
        TXControlType ITXControl.ControlType
        {
            get { return TXControlType.RollingBar; ; }
        }
    }
}

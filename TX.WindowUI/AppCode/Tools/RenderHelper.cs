...
namespace TX.WindowUI.AppCode.Tools
{
    class RenderHelper
    {
        /// <summary>
        ...
        public static void SetFormRoundRectRgn(Control form, int rgnRadius)
        {
            int hRgn = 0;
        ...
        public static void MoveWindow(Form form)
        {
            ...
            WinAPI.SendMessage(form.Handle, WinAPI.WM_NCLBUTTONDOWN, WinAPI.HTCAPTION, 0);
        }
        ...
        /// 获取当前命名空间下嵌入的资源
        /// </summary>
        /// <param name="imagePath">嵌入资源的路径</param>
        public static Stream GetFormResourceStream(string path)
        {
            string fillName = MethodBase.GetCurrentMethod().DeclaringType.Namespace + "." + path;
            var xx = Assembly.GetExecutingAssembly();
            return xx.GetManifestResourceStream(fillName);
        }
